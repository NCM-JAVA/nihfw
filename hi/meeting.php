...
<div class="row">
   ...
   <li><a href = "<?php echo $HomeURL;?>/hi" title="मुख्य पृष्">मुख्य पृष्</a></li>
   <li class = "active"><a href="<?php echo $HomeURL;?>/hi/meeting.php" title="बैठक एवं घटनाक्रम / कार्यशाला और प्रशिक्षण">बैठक एवं घटनाक्रम / कार्यशाला और प्रशिक्षण</a></li>
	 <?php if($_GET['page']!='') { ?> 
		...
		<tbody>
		 ...
		 foreach($newsrows as $key=>$value){ 
			...
			<tr>
			   ...
			   <?php } else { ?>
			   <a href="<?php echo $HomeURL;?>/hi/meeting.php?page=<?php echo $value['page_url']; ?>" title="<?php echo $value['m_name'];?>"><?php echo $value['m_name'];?></a>
			   <?php } ?></td>
				<td>
