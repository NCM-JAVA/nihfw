...
<select name="textcatgory" id="textcatgory" autocomplete="off"  >
...
<div class="clear"></div>
  ...
  <table  class="table table-bordered">
			...
			{	
				...
				{
					  $counter1 = $counter + $pager->offset;
					 $docspath =  '../nihfw/upload/recruitment/'.$value['docs_file'];
					 $file='../upload/recruitment/'.$value['docs_file'];
				?>
			   <tr>
			   <td><?php echo $counter1;?></td>
			   <td>
			   <?php if($value['docs_file']!='') {
	//$new12 = str_replace(' ', '%20', $docspath);
			    ?>
			   ...
			   <?php echo ' size:( '.formatFilebytes($docspath ,'MB').')'; ?>
			   <?php }
			   ...
			   <?php } else { ?>
			   <a href="<?php echo $HomeURL;?>/vacancy.php?page=<?php echo $value['page_url']; ?>" title="<?php echo $value['m_name'];?>"><?php echo $value['m_name'];?></a>
			   <?php } ?>
			   </td>
			   ...
			   <td><?php echo date("d-m-Y", strtotime($value['end_date']));?></td>
			    ...
			    <?php $counter++; } ?> 
				<tr><td colspan="4"><div class="pagination"><span class="page gradient"><?php echo $pager->renderFullNav();?></span></div></td></tr>		
				<?php 
						}
				else
				{?>
